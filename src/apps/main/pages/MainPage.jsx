    ...
    <div className="main">
      <div className="main-page">
        ...
        <div className='chart-container'>
          <ChartComponent title="Рекламные размещения" lefttitle="количество" />
        ...
        <div className="channels-table">
          <div className="table-top">
            ...
            <ul className="chanels-status">
              ...
              <li className="status-item">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="12" cy="12" r="11" fill="#00CC5E" stroke="white" strokeWidth="2" />
                  <path d="M9.95589 15.4528C10.1339 15.6232 10.3679 15.709 10.6013 15.709C10.8347 15.709 11.0687 15.6238 11.2467 15.4528L16.7325 10.2013C17.0892 9.85988 17.0892 9.30649 16.7325 8.96506C16.3758 8.62363 15.7978 8.62363 15.4411 8.96506L10.6013 13.5981L8.55891 11.643C8.20224 11.3015 7.62416 11.3015 7.2675 11.643C6.91083 11.9844 6.91083 12.5378 7.2675 12.8792L9.95589 15.4528Z" fill="white" />
                </svg>
                - одобрен
              </li>
              <li className="status-item">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="12" cy="12" r="11" fill="#FF0000" stroke="white" strokeWidth="2" />
                  <path d="M8 16L16 8M16 16L8.00001 8" stroke="white" strokeWidth="1.7" strokeLinecap="round" />
                </svg>
                - отклонен
              </li>
            </ul>
          ...
          <table className='table'>
            <thead className='table-head'>
              <tr>
                      ...
                      <div className={"select-option " + (item.selected ? "selected" : '')} key={item.id} onClick={() => handleSelect(item.id)}>
                        <div className="icon">
                          <svg width="11" height="10" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M5.41658 9.16699C5.41658 9.51217 5.13676 9.79199 4.79158 9.79199H0.624918C0.279751 9.79199 -8.2016e-05 9.51217 -8.2016e-05 9.16699C-8.2016e-05 8.82182 0.279751 8.54199 0.624918 8.54199H4.79158C5.13676 8.54199 5.41658 8.82182 5.41658 9.16699ZM10.0833 5.00033C10.0833 5.34549 9.80343 5.62533 9.45825 5.62533H0.624918C0.279751 5.62533 -8.2016e-05 5.34549 -8.2016e-05 5.00033C-8.2016e-05 4.65516 0.279751 4.37533 0.624918 4.37533H9.45825C9.80343 4.37533 10.0833 4.65516 10.0833 5.00033ZM7.74992 0.833659C7.74992 1.17883 7.47009 1.45866 7.12492 1.45866H0.624918C0.279751 1.45866 -8.2016e-05 1.17883 -8.2016e-05 0.833659C-8.2016e-05 0.488493 0.279751 0.208659 0.624918 0.208659H7.12492C7.47009 0.208659 7.74992 0.488493 7.74992 0.833659Z" fill="white" />
                          </svg>
                        </div>
                        {item.title}
                      </div>
                ...
                <th className='th'>Средний охват рекламного поста, просмотров</th>
                  ...
                  <div className="chanel-img">
                    ...
                    <span className='created'>
                      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="14" cy="14" r="13" fill="#818181" stroke="white" strokeWidth="2" />
                      </svg>
                    </span>
                  </div>
                      ...
                      <div className="man-subscriber">
                        ...
                        <span className='audience man-audience'>
                          <svg width="8" height="21" viewBox="0 0 8 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 20.416C4.89543 20.416 4 19.5206 4 18.416L4 14.416L-4.37114e-07 10.416L4 6.41602L4 2.41602C4 1.31145 4.89543 0.416015 6 0.416015C7.10457 0.416015 8 1.31144 8 2.41602L8 18.416C8 19.5206 7.10457 20.416 6 20.416Z" fill="url(#paint0_linear_319_2103)" />
                            <defs>
                              <linearGradient id="paint0_linear_319_2103" x1="6" y1="22.416" x2="6" y2="-1.58399" gradientUnits="userSpaceOnUse">
              ...
              <tr>
                <td className='td chanel-td'>
                  <div className="chanel-img">
                    ...
                    <span className='created'>
                      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="14" cy="14" r="13" fill="#00CC5E" stroke="white" strokeWidth="2" />
                        <path d="M11.9559 17.1598C12.1339 17.3302 12.3679 17.416 12.6013 17.416C12.8347 17.416 13.0687 17.3308 13.2467 17.1598L18.7325 11.9083C19.0892 11.5669 19.0892 11.0135 18.7325 10.6721C18.3758 10.3307 17.7978 10.3307 17.4411 10.6721L12.6013 15.3052L10.5589 13.35C10.2022 13.0086 9.62416 13.0086 9.2675 13.35C8.91083 13.6914 8.91083 14.2448 9.2675 14.5862L11.9559 17.1598Z" fill="white" />
                      </svg>
                    </span>
                  </div>
                  <div className="chanel-info">
              ...
              <tr>
                <td className='td chanel-td'>
                  <div className="chanel-img">
                    ...
                    <span className='created'>
                      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="14" cy="14" r="13" fill="#FF0000" stroke="white" strokeWidth="2" />
                        <path d="M10 17.708L18 9.70801M18 17.708L10 9.70801" stroke="white" strokeWidth="1.7" strokeLinecap="round" />
                      </svg>
                    </span>
                  </div>
                  <div className="chanel-info">
