            ...
            <table className='table'>
              <thead className='table-head'>
                <tr>
                  ...
                  <th className='th th-subscribers'>Пост
                  </th>
                  <th className='th clock-th'>Дата и время
                    <button className="date-btn" onClick={openMenu}>
                      <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd" clipRule="evenodd" d="M9.78033 0.46967C10.0732 0.762563 10.0732 1.23744 9.78033 1.53033L5.78033 5.53033C5.48744 5.82322 5.01256 5.82322 4.71967 5.53033L0.719669 1.53033C0.426777 1.23744 0.426777 0.762563 0.719669 0.46967C1.01256 0.176776 1.48744 0.176776 1.78033 0.469669L5.25 3.93934L8.71967 0.46967C9.01256 0.176777 9.48744 0.176777 9.78033 0.46967Z" fill="#262626" />
                      </svg>
                    </button>
                  </th>
                  <th className='th status-th'>
                    ...
                    <div className={"select-menu " + (subscriber ? 'show' : '')}>
                      {subscribers.map(item => (
                        <div className={"select-option " + (item.selected ? "selected" : '')} key={item.id} onClick={() => handleSelect(item.id)}>
                ...
                <tr>
                  <td className='td chanel-td'>
                    ...
                    <div className="chanel-info">
                      <h4 className="chanel-name">
                        Varlamov News
                      </h4>
                      <p className="chanel-status">
                        Новостной портал
                      </p>
                    </div>
                  </td>
            ...
            <div className="table-bottom">
              ...
              <div className="table-pagination">
                ...
                <button className="next-button">
                  <svg width="7" height="11" viewBox="0 0 7 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M0.775834 0.275345C1.01015 0.0410307 1.39005 0.0410307 1.62436 0.275345L6.42436 5.07535C6.65868 5.30966 6.65868 5.68956 6.42436 5.92387L1.62436 10.7239C1.39005 10.9582 1.01015 10.9582 0.775835 10.7239C0.54152 10.4896 0.54152 10.1097 0.775834 9.87535L5.15157 5.49961L0.775834 1.12387C0.541519 0.889559 0.541519 0.50966 0.775834 0.275345Z" fill="#262626" />
                  </svg>
                </button>
              </div>
